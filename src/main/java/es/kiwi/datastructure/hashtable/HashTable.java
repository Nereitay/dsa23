...
public class HashTable {
    ...
    Entry[] table = new Entry[16];// 2的n次方
    int size = 0;// 元素个数
 ...
 */
    ...
    /* 基于数组长度是 2的n次方,效率高，分散性不好
            1. 按位与
            2. 拆分链表
            3. 高低位异或

       特例：HashTable 效率低，分散性好    11 质数
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("===========================");
        // 字符串的hashcode方法已经重写过了
        String s1 = "abc";
        String s2 = new String("abc");
        System.out.println(s1.hashCode());
        System.out.println(s2.hashCode());

        // 生成字符串hash码的原则：值相同的字符串生成相同的hash码，尽量让值不同的字符串生成不同的hash码
         /*
            对于 abc  a * 100 + b * 10 + c
            对于 bac  b * 100 + a * 10 + c
         */
...
//            hash = hash * 10 + c;  // (a*10 + b)*10 + c  ==>  a*100 + b*10 + c  2^5
//            hash = hash * 31 + c;
//            hash = hash * 32 - hash + c;
            hash = (hash << 5) - hash + c;
        }
        ...
        System.out.println("===========================");
        // Murmur hash
        int hash1 = Hashing.murmur3_32().hashString("abc", StandardCharsets.UTF_8).asInt();
    ...
    private static int getHash(Object key) {
        ...
        return hash ^ (hash >>> 16);// 高低位相互异或减少冲突
    }
